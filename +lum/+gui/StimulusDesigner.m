...
controls.MixtureLayout = placed(uidropdown(form, 'Items', {'Both from stimulus onset', ...
    'Both centred in the window'}, 'ItemsData', {'onset', 'centred'}, ...
    'ValueChangedFcn', @(~, ~) refresh(), 'Tooltip', 'Where in the window each amount is lit'), 5, 2);
