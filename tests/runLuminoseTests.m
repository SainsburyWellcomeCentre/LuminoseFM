...
files = {'lintTest', 'generateTest', 'patternTest', 'stimulusSetTest', 'cueTimingTest', ...
         ...
         'punishmentTest', 'valveTimesTest', 'trainingStageTest', 'scoreTrialTest', 'pulsePalTest', 'houseLightTest', ...
         'ledTest', 'doricTest', 'ephysTest', 'sleepTest', 'stateMachineTest', 'windowsTest', ...
         'emulatorSessionTest', 'habituationSessionTest', 'animalSessionTest', 'sleepSessionTest', ...
         'ephysSessionTest', 'cameraTest'};
