...
files = {'lintTest', 'generateTest', 'patternTest', 'stimulusSetTest', 'cueTimingTest', ...
         ...
         'punishmentTest', 'trainingStageTest', 'scoreTrialTest', 'pulsePalTest', 'houseLightTest', ...
         'ledTest', 'doricTest', 'ephysTest', 'sleepTest', 'stateMachineTest', 'windowsTest', ...
         'emulatorSessionTest', 'habituationSessionTest', 'sleepSessionTest', 'ephysSessionTest', ...
         'cameraTest'};
